...
<body>
  ...
  <div class="container ">
    ...
    <h1 class="main-title">Pokémons iniciales de Kanto</h1>
    <span class="initial-pokemons">Bulbasaur, Charmander y Squirtle</span>
    <div class="pokemons-container">

      <?php
      foreach ($images as $image) {
        echo "<div class='pokemons-img'>
    ...
    <h1 class="main-title">Pokémons iniciales de Johto</h1>
    <span class="initial-pokemons">Chikorita, Cyndaquil y Totodile</span>
    <div class="pokemons-container">
