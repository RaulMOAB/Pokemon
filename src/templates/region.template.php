    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"> <a class="nav-link link-light" href="data.html" aria-current="pokemon-dates">PokeAPI</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="container ">
    ...
    <div class="pokemons-container">
      ...
      foreach ($regions as $region => $array_asosiativo) {
        extract($images);
        echo "
            <span class='initial-pokemons'>$region_name</span>
            <div class='pokemons-img'>
                <img class='poke-img' src='$url' alt='region-pokemon's>
             </div>";
      }
